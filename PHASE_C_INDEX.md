...
|---|---|---|---|---|---|
| 01 | [Claims-grounding LLM judge](phase-c/01-claims-grounding-judge.md) | #A | drafted | 🔴 critical (legal) | medium |
| 02 | [Marketplace selection + autopublish cleanup](phase-c/02-marketplace-selection.md) | #1, #2, #3, #4, #9, #20 | drafted | 🔴 critical (UX) | medium |
| 03 | [Tenant defaults in Settings](phase-c/03-tenant-defaults.md) | #18, #19 | drafted | 🟠 high | medium |
| 04 | [Add Product form fixes](phase-c/04-add-product-form.md) | #17b, #23, #24, #25, #34 | drafted | 🟠 high | small |
