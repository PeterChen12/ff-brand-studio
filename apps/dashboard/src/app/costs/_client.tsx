...
// P2-8 — recharts is ~80KB and only used here. next/dynamic + ssr:false
// puts it in its own chunk so / and other routes aren't paying for it.
const SpendChart = dynamic(() => import("./_chart").then((m) => m.SpendChart), {
  ssr: false,
