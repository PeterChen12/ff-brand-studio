...
| 02 | [BFR adapter `stage(ctx)` completion (R5)](phase-f/02-bfr-adapter-stage.md) | none | 🟠 medium | ✅ shipped studio-side (BFR receiver pending other agent) | medium-large |
...
| 08 | [E6.1 — Agentic LLM folder walk](phase-f/08-agentic-folder-walk.md) | none | 🟡 low | ✅ partial (server lib + tests; endpoint + UI deferred to F8.1/F8.2) | large |
